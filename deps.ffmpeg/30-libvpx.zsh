...
local -A urls=(
  macos https://github.com/webmproject/libvpx/archive/v1.15.2.tar.gz
  linux https://github.com/webmproject/libvpx/archive/v1.15.2.tar.gz
  windows https://github.com/webmproject/libvpx/archive/v1.15.2.tar.gz
)
local -A hashes=(
  macos "${0:a:h}/checksums/v1.15.2.tar.gz.sha256"
  linux "${0:a:h}/checksums/v1.15.2.tar.gz.sha256"
  windows "${0:a:h}/checksums/v1.15.2.tar.gz.sha256"
)
local -a patches=(
